      ...
      <div class="d-md-flex align-items-center justify-content-between mb-4">
        <div>
          <ol class="breadcrumb fs-sm mb-1">
            <li class="breadcrumb-item"><a href="/dashboard-teknisi">Dashboard</a></li>
            ...
            <table class="table table-bordered mb-0">
              ...
              <tbody>
                <tr>
                  ...
                  <td></td>
                  <td rowspan="5">
                    <a href="#modal1" class="btn btn-primary" data-bs-toggle="modal">Finish</a>
                  </td>
                  <td rowspan="5">Solved</td>
                </tr>
              </tbody>
            </table>
          </div>
